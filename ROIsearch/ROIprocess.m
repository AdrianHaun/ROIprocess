...
if Iso == 1
    ...
    [MSroi_end,mzroi_end,Parameters]=filterIsotopes(MSroi_end,mzroi_end,Parameters);
    disp('DONE');
end
if add == 1
    disp('Removing Adducts...');
    [MSroi_end,mzroi_end,Parameters]=filterAdducts(MSroi_end,mzroi_end,Parameters);
    disp('DONE');
end
if Cont == 1
